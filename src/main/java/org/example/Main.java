    ...
    public static void main(String[] args) {
        ...
        try {
           ...
           Domicilio domicilio1 = new Domicilio("San Martin",1224);
            ...
            //Factura factura1 = em.find(Factura.class, 1L); Esta linea se utilliza para actualizar la factura1
            //factura1.setNumero(84); //Cambio el número de la factura

            // em.remove(factura1); //Se utiliza para borrar la factura1
            //em.merge(factura1); //se utiliza para actualizar la factura
            em.persist(factura1);
